...
# path('printHello/', views.printHello, name='printHello'),
# path('takeInput/', views.imageToPDF, name='takeInput'),
# path('mergePDF/', views.mergePDF, name='mergePDF'),
# path('setPassword/', views.setPassword, name='setPassword'),
# path('removePassword/', views.removePassword, name='removePass'),
# path('imageToPDFm2/', views.imageToPDFm2, name='imageToPDFm2'),
# path('compressPDF/', views.compressPDF, name='compressPDF'),
# path('wordToPDF/', views.wordToPDF, name='wordToPDF'),
# path('excelToPDF/', views.excelToPDF, name='excelToPDF'),
# path('HTMLToPDF/', views.HTMLToPDF, name='HTMLToPDF'),
# path('CompressImage/', views.CompressImage, name='CompressImage'),
# path('PDFtoExcel/', views.PDFtoExcel, name='PDFtoExcel'),
# path('PDFtoAudioBook/', views.PDFtoAudioBook, name='PDFtoAudioBook'),
# path('TextToPDF/', views.TextToPDF, name='TextToPDF'),
# path('splitPDF/', views.splitPDf, name='splitPDF'),
# path('extractTextFromPDF/', views.extractTextFromPDF, name='extractTextFromPDF'),